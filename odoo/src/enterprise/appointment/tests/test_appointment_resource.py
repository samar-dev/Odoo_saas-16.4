...
class AppointmentResourceBookingTest(AppointmentCommon):
    ...
    def test_appointment_resources_combinable_last_availability(self):
        ...
        self._test_slot_generate_available_resources(self.apt_type_resource, 2, 'UTC', start, end, table_c3, available_resources_c2)
    ...
    def test_appointment_resources_combinable_with_time_resource(self):
        ...
        self._test_slot_generate_available_resources(self.apt_type_resource, 2, 'UTC', start, end, table_c2 + table_c3, available_resources_c2)
        ...
        self._test_slot_generate_available_resources(self.apt_type_resource, 5, 'UTC', start, end, table_c2 + table_c3, available_resources_c5)
