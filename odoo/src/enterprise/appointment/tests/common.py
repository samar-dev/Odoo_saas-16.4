...
class AppointmentCommon(MailCommon, common.HttpCase):
    ...
    def _test_slot_generate_available_resources(self, appointment_type, asked_capacity, timezone, start_dt, end_dt, filter_resources, expected_available_resource_ids):
        ...
        :param start_dt<datetime>: start datetime of the slot (UTC)
        :param end_dt<datetime>: end datetime of the slot (UTC)
        ...
        """
        slots = appointment_type._slots_generate(start_dt, end_dt, timezone)
