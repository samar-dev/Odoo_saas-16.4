...
export const studioService = {
    dependencies: ["action", "cookie", "color_scheme", "home_menu", "router", "user", "rpc", "menu", "notification"],
    async start(env, { user, cookie, color_scheme, rpc, menu, notification }) {
            ...
            if (!inStudio) {
                ...
                try {
                    ...
                    if (e instanceof NotEditableActionError) {
                        notification.add(_lt("This action is not editable by Studio"), { type: "danger" });
                        return;
                    }
                    throw e;
                }
