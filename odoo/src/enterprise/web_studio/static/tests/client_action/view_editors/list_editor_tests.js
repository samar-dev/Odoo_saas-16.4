            ...
            await createViewEditor({
                ...
                mockRPC: function(route, args) {
                    if (route === "/web_studio/edit_view") {
                        ...
                        assert.notOk("force_save" in args.operations[0].new_attrs, 'No "force_save" attributes');
                        changeArch(args.view_id, arch);
                    }
                }
            });

            await click(target.querySelector(".o_web_studio_list_view_editor [name='display_name']"));
