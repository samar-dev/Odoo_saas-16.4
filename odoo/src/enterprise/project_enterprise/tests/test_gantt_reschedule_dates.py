...
class TestGanttRescheduleOnTasks(ProjectEnterpriseGanttRescheduleCommon):
    ...
    def test_gantt_reschedule_date_not_active(self):
        ...
        def test_task_3_dates_unchanged(task_1_new_planned_dates, failed_message, domain_force=False, **context):
            ...
            self.assertEqual(self.task_3_planned_date_end, self.task_3.planned_date_end, failed_message)
            task_1.write({
    ...
    def test_gantt_reschedule_on_dependent_task_with_planned_hours(self):
        ...
        self.assertEqual(
            self.task_3.planned_date_end, self.task_3_planned_date_end + relativedelta(days=1, hour=9),
            failed_message
        )
