    ...
    def test_partner_ledger_unfold(self):
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('01/01/2017',                          2000.0,         0.0,            2150.0),
                ('01/01/2017',                          3000.0,         0.0,            5150.0),
                ('01/01/2017',                          4000.0,         0.0,            9150.0),
                ('01/01/2017',                          5000.0,         0.0,            14150.0),
                ('01/01/2017',                          6000.0,         0.0,            20150.0),
    ...
    def test_partner_ledger_filter_account_types(self):
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('01/01/2017',                          4000.0,         0.0,            4000.0),
                ('01/01/2017',                          5000.0,         0.0,            9000.0),
                ('01/01/2017',                          6000.0,         0.0,            15000.0),
    ...
    def test_partner_ledger_unknown_partner(self):
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('06/01/2017',                          200.0,          0.0,            -800.0),
                ('06/01/2017',                          0.0,            200.0,          -1000.0),
                ('03/31/2017',                          1000.0,         0.0,            0.0),
    ...
    def test_partner_ledger_prefix_groups(self):
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('Brave partner',                     42.0,            0.0,             42.0),
                (invoices_map['Brave partner'],       42.0,            0.0,             42.0),
