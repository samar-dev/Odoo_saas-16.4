...
class HrAppraisal(models.Model):
    ...
    def action_open_survey_inputs(self):
        self.ensure_one()
        view_id = self.env.ref('hr_appraisal_survey.hr_appraisal_survey_user_input_view_tree', raise_if_not_found=False) or \
                  self.env.ref('hr_appraisal_survey.survey_user_input_view_tree', raise_if_not_found=False)
