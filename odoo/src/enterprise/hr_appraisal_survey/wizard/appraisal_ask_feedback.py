...
class AppraisalAskFeedback(models.TransientModel):
    ...
    template_id = fields.Many2one(default=lambda self: self.env.ref('hr_appraisal_survey.mail_template_appraisal_ask_feedback_formatted', raise_if_not_found=False))
