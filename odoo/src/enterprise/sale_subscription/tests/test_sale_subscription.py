...
class TestSubscription(TestSubscriptionCommon):
    ...
    def test_qty_invoiced_after_revert(self):
        ...
        self.assertEqual(subscription.order_line.qty_invoiced, 0.0)
        invoice.action_post()
        self.assertEqual(subscription.order_line.qty_invoiced, 2.0)
        ...
        self.assertEqual(subscription.order_line.qty_invoiced, 2.0, "Invoiced quantity on the order line is not correct")
    ...
    def test_negative_subscription(self):
        ...
        self.product2.product_pricing_ids.unlink()
        sub_negative_recurring = self.env['sale.order'].create({
