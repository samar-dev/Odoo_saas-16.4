...
import { PostFormatterField } from '@social/js/fields/post_formatter_field';
...
patch(PostFormatterField.prototype, 'social_instagram.PostFormatterField', SocialPostFormatterMixin);
